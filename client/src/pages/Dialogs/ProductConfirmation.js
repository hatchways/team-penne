...
function ProductConfirmationDialog() {
    ...
    const [loadingButtonLabelConfirm, setLoadingButtonLabelConfirm] = React.useState("CONFIRM");
    const [loadingButtonLabelDeny, setLoadingButtonLabelDeny] = React.useState("GO BACK");
        ...
        <DialogContent classes={{ root: classes.dialogContent }}>
          ...
          <div>
            ...
            >
              ...
              {loadingDeny && <CircularProgress size={24} className={classes.buttonProgress} />}
            </Button>
          </div>
        </DialogContent>
      </Dialog>
